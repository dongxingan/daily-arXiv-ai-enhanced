...
### [17] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*

Main category: cs.MA

TL;DR: 论文提出了一种名为AOMEA的辅助多智能体系统组织工程方法，通过结合多智能体强化学习和组织模型，简化复杂部署环境中的MAS设计。


<details>
  <summary>Details</summary>
Motivation: 多智能体系统（MAS）在复杂分布式问题中表现出色，但其设计效率高度依赖部署环境的复杂性。现有方法需要设计师对部署环境有深入了解，而高复杂性和低可读性环境增加了设计成本和安全隐患。

Method: AOMEA方法结合多智能体强化学习（MARL）和组织模型，为MAS工程提供相关的组织规范建议。

Result: AOMEA能够有效简化MAS组织设计，降低设计成本并提升安全性。
...
### [18] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*

Main category: cs.MA

TL;DR: 论文提出了一种基于Transformer的集中式方法（MAT-NAHT），用于解决N-agent ad hoc teamwork问题，优于现有独立学习方法POAM。


<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法（POAM）无法充分捕捉多智能体间的动态协作关系，而Transformer在处理变长序列和多任务学习方面表现优异。

Method: 采用集中式Transformer架构，整合所有受控智能体的历史观察和动作，以应对部分可观测环境中的未知队友。

Result: 在StarCraft II任务中，MAT-NAHT在样本效率和泛化能力上优于POAM，且无需额外的智能体建模目标。

Conclusion: MAT-NAHT通过Transformer有效解决了NAHT问题，展示了其在多智能体协作中的潜力。
...
### [19] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*

Main category: cs.MA

TL;DR: 论文探讨了生成式AI（如大型语言模型LLM）在集体风险社会困境（CRSD）研究中的可行性，以替代传统大规模人类实验。


<details>
  <summary>Details</summary>
Motivation: CRSD研究（如气候变化）需要大规模人类实验，但难以保证统计功效和社会人口多样性。生成式AI提供了一种补充方法。

Method: 使用LLM替代人类参与者，构建可扩展的实证框架，验证其在大规模人类实验中的代表性和多样性。

Result: 论文验证了LLM在CRSD研究中的可行性，尤其是在复杂情境（如"Port of Mars"）中的表现。

Conclusion: 生成式AI可作为CRSD研究的有效补充工具，但需进一步验证其多样性和代表性。
...
### [20] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实验支持。本文通过实验验证其在公共物品博弈中的表现，发现人类和AI在可识别条件下表现更好，均采用轮流策略。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在复杂社会行为建模中的有效性，尤其是通过实验支持其在公共物品博弈中的应用。

Method: 使用多智能体强化学习模型模拟人类在公共物品博弈中的行为，对比可识别和匿名条件下的表现。

Result: 人类和AI在可识别条件下表现更优，均采用轮流策略解决问题。

Conclusion: 多智能体强化学习是建模复杂社会行为的有效工具，尤其在可识别条件下表现突出。
...
### [21] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*

Main category: cs.MA

TL;DR: 提出了一种名为AOMEA的辅助多代理系统组织工程方法，结合多代理强化学习和组织模型，以简化复杂部署环境中的MAS设计。


<details>
  <summary>Details</summary>
Motivation: 多代理系统（MAS）在复杂分布式问题中表现优异，但其设计效率高度依赖部署环境知识，复杂环境可能导致高成本或安全问题。

Method: 结合多代理强化学习（MARL）和组织模型，提出AOMEA方法，用于生成相关组织规范。
...
### [22] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*

Main category: cs.MA

TL;DR: 本文提出了一种基于Transformer的集中式方法MAT-NAHT，用于解决N-agent ad hoc teamwork（NAHT）问题，显著优于现有方法POAM。


<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法（如POAM）无法充分捕捉多智能体协作中的动态交互，而Transformer能有效处理变长序列，适合解决NAHT问题。

Method: 提出集中式Transformer方法MAT-NAHT，利用所有受控智能体的历史观察和动作，以应对部分可观测环境中多样化的未知队友。

Result: 在StarCraft II任务上的实验表明，MAT-NAHT在样本效率和泛化能力上优于POAM，且无需额外建模目标。
...
### [23] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*
...
<details>
  <summary>Details</summary>
Motivation: 解决CRSD研究中大规模人类实验的挑战，如样本多样性和统计功效不足的问题。

Method: 使用大型语言模型（LLM）模拟人类行为，验证其在CRSD研究中的有效性。

Result: 初步验证了LLM在模拟复杂CRSD（如Port of Mars）中的潜力。

Conclusion: 生成式AI可作为CRSD研究的补充工具，但需进一步验证其多样性和真实性。
...
### [24] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实验支持。本文通过实验证明其在公共物品提供游戏中的有效性。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在模拟真实人类群体行为中的实用性。

Method: 在公开物品提供游戏Clean Up中，比较人类和智能体在可识别与匿名条件下的表现。

Result: 人类和智能体在可识别条件下成功合作，匿名条件下失败，且均通过轮换解决问题。
...
### [25] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*
...
<details>
  <summary>Details</summary>
Motivation: 多智能体系统在复杂分布式问题中表现优异，但其组织结构设计依赖于设计师对部署环境的了解，而高复杂性和低可读性环境增加了设计成本和安全性风险。

Method: 提出AOMEA方法，结合多智能体强化学习（MARL）和组织模型，生成相关的组织结构规范。

Result: AOMEA能够为多智能体系统工程提供有效的组织结构建议。

Conclusion: AOMEA方法通过自动化和辅助设计，降低了多智能体系统在复杂环境中的设计难度和风险。
...
### [26] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*
...
<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法（POAM）无法充分捕捉多智能体间的动态交互，而Transformer能有效处理变长序列，适合NAHT问题。

Method: 提出集中式Transformer方法，整合所有受控智能体的历史观察和动作，以应对部分可观测环境中的未知队友。

Result: 在StarCraft II任务中，MAT-NAHT表现优于POAM，具有更高的样本效率和泛化能力。

Conclusion: Transformer方法在NAHT问题中表现出色，无需额外建模目标即可实现高效协作。
...
### [27] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*

Main category: cs.MA

TL;DR: 论文探讨了用生成式AI（如大语言模型LLM）替代人类参与者，以解决集体风险社会困境（CRSD）研究中大规模实验的挑战，并验证其可行性和多样性。
...
Method: 使用大语言模型（LLM）模拟人类参与者，验证其在大规模CRSD实验中的可行性和多样性表现。

Result: 论文验证了LLM在模拟复杂CRSD（如Port of Mars）中的潜力，可作为人类实验的补充。

Conclusion: 生成式AI（LLM）为CRSD研究提供了可扩展的替代方案，但需进一步验证其多样性和真实性。
...
### [28] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实验支持。本文通过实验验证其在公共物品游戏中的表现，发现声誉和身份可见性对合作至关重要。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在模拟真实人类群体行为中的有效性，特别是在复杂社会环境中。

Method: 在公共物品游戏Clean Up中对比人类和智能体在匿名与身份可见条件下的表现，并开发声誉合作模型。

Result: 人类和智能体在身份可见时成功合作，匿名时失败；两者均通过轮流解决问题。

Conclusion: 多智能体强化学习能有效模拟复杂社会行为，声誉和身份可见性是关键因素。
...
### [29] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*

Main category: cs.MA

TL;DR: 提出了一种名为AOMEA的方法，通过结合多智能体强化学习和组织模型，辅助设计多智能体系统的组织结构，以解决复杂部署环境中的高成本和安全性问题。


<details>
  <summary>Details</summary>
Motivation: 多智能体系统（MAS）在复杂分布式问题中表现优异，但其设计效率高度依赖于部署环境的知识。复杂和低可读性的环境导致现有方法成本高或存在安全隐患。

Method: 结合多智能体强化学习（MARL）和组织模型，提出AOMEA方法，为MAS工程提供相关的组织规范建议。

Result: AOMEA能够辅助设计MAS的组织结构，降低复杂环境中的设计成本和安全性风险。

Conclusion: AOMEA为复杂部署环境中的MAS设计提供了一种有效的辅助方法，提高了设计效率和安全性。
...
### [30] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*
...
<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法POAM无法充分捕捉多智能体间的动态协作关系，而Transformer在处理变长序列和多任务学习上表现优异。

Method: 采用集中式Transformer架构，整合所有受控智能体的历史观察和动作，以应对部分可观测环境中的未知队友。

Result: 在StarCraft II任务中，MAT-NAHT在样本效率和泛化能力上优于POAM，且无需额外建模目标。

Conclusion: MAT-NAHT为NAHT问题提供了一种高效且通用的解决方案，展现了Transformer在多智能体协作中的潜力。
...
### [31] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*

Main category: cs.MA

TL;DR: 论文探讨了用生成式AI（如LLM）替代人类参与者进行集体风险社会困境（CRSD）研究的可行性，以解决大规模实验的多样性和统计效力问题。


<details>
  <summary>Details</summary>
Motivation: 理解CRSD（如气候变化）的社会基础需要大规模实验，但传统方法难以保证多样性和统计效力，生成式AI提供了一种补充方案。

Method: 使用大型语言模型（LLM）模拟人类参与者，验证其在CRSD研究中的可行性和多样性表现。

Result: 研究发现LLM可以作为一种有效的工具，模拟大规模人类实验并提供足够的多样性。

Conclusion: 生成式AI（如LLM）在CRSD研究中具有潜力，可作为传统人类实验的补充方法。
...
### [32] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实验支持。本文通过实验验证其在公共物品博弈中的有效性，发现人类和AI在可识别条件下表现更好。
...
Method: 使用公共物品博弈（Clean Up）实验，比较人类和AI在可识别与匿名条件下的表现。

Result: 人类和AI在可识别条件下表现更优，均通过轮流合作解决问题。

Conclusion: 多智能体强化学习能有效模拟复杂社会行为，尤其在可识别条件下。
...
### [33] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*

Main category: cs.MA

TL;DR: 论文提出了一种名为AOMEA的方法，通过结合多智能体强化学习和组织模型，简化复杂部署环境中的多智能体系统设计。


<details>
  <summary>Details</summary>
Motivation: 复杂部署环境中的高复杂性和低可读性使得传统多智能体系统设计方法成本高或存在安全隐患，需要一种更高效的方法。

Method: 结合多智能体强化学习（MARL）和组织模型，提出AOMEA方法，为多智能体系统设计提供组织规范建议。

Result: AOMEA能够简化多智能体系统的组织设计，降低设计成本并提高安全性。

Conclusion: AOMEA为复杂环境中的多智能体系统设计提供了一种有效的辅助方法。
...
### [34] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*

Main category: cs.MA

TL;DR: 论文提出了一种基于Transformer的集中式方法（MAT-NAHT），用于解决N-agent ad hoc teamwork（NAHT）问题，显著优于现有独立学习方法（POAM）。


<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法（POAM）无法充分捕捉多智能体间的动态协作关系，而Transformer能有效处理变长序列，适合解决NAHT问题。

Method: 采用集中式Transformer方法，整合所有受控智能体的历史观察和动作，以应对部分可观测环境中未知队友的多样性。

Result: 在StarCraft II任务中，MAT-NAHT表现优于POAM，具有更高的样本效率和泛化能力，且无需额外建模目标。

Conclusion: 基于Transformer的集中式方法为NAHT问题提供了更优的解决方案，展现了其在多智能体协作中的潜力。
...
### [35] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*

Main category: cs.MA

TL;DR: 论文探讨了生成式AI（如大语言模型）在集体风险社会困境（CRSD）研究中的可行性，以解决大规模人类实验的局限性。
...
Method: 使用大语言模型（LLM）替代人类参与者，验证其在大规模、多样化CRSD实验中的可行性。

Result: 研究表明LLM可以模拟人类行为的多样性，为CRSD研究提供可扩展的实证框架。

Conclusion: 生成式AI是研究CRSD的有效补充工具，尤其在模拟复杂社会困境时具有潜力。
...
### [36] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实证支持。本文通过实验验证其在公共物品博弈中的有效性，发现人类和AI在可识别身份时表现更好。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在模拟人类复杂社会行为中的实用性，填补实验支持的空白。

Method: 通过实验室实验和AI模型对比，研究身份识别与匿名条件下的人类和AI行为。

Result: 人类和AI在身份可识别时表现更优，且均通过轮流解决问题。
...
### [37] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*
...
<details>
  <summary>Details</summary>
Motivation: 多智能体系统（MAS）在复杂分布式问题中表现优异，但其设计效率高度依赖设计者对部署环境的了解。复杂且低可读性的环境导致现有方法成本高或存在安全隐患。

Method: 提出AOMEA方法，结合多智能体强化学习（MARL）和组织模型，生成相关组织规范以辅助MAS设计。

Result: AOMEA能够为MAS工程提供有效的组织规范建议，降低设计成本和风险。
...
### [38] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*
...
<details>
  <summary>Details</summary>
Motivation: 现有独立学习方法POAM无法充分捕捉多智能体间的动态协作关系，而Transformer能有效处理变长序列，适合解决NAHT问题。

Method: 提出集中式Transformer方法MAT-NAHT，利用所有受控智能体的历史观察和动作，以应对部分可观测环境中未知队友的多样性。

Result: 在StarCraft II任务中，MAT-NAHT表现优于POAM，具有更高的样本效率和泛化能力。

Conclusion: MAT-NAHT通过Transformer的集中式学习，显著提升了多智能体动态协作的性能。
...
### [39] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*

Main category: cs.MA

TL;DR: 论文探讨了利用生成式AI（如LLM）模拟大规模人类实验的可行性，以解决集体风险社会困境（CRSD）研究中的规模和多样性问题。


<details>
  <summary>Details</summary>
Motivation: 理解CRSD（如气候变化）的社会基础需要大规模实验，但传统方法难以保证足够的统计功效和社会人口多样性。

Method: 使用大型语言模型（LLM）替代人类参与者，构建可扩展的实证框架，验证其能否模拟复杂CRSD实验（如Port of Mars）。

Result: 研究评估了LLM在模拟人类多样性方面的有效性，为CRSD研究提供了新方法。

Conclusion: 生成式AI可作为补充工具，为CRSD研究提供大规模、多样化的实验模拟。
...
### [40] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习在复杂社会行为模拟中优于传统理论方法，但缺乏实证支持。本文通过实验验证其在公共物品博弈中的有效性，发现人类和AI在可识别身份时表现更好，均采用轮流策略。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在复杂社会行为模拟中的实证效果，填补实验室实验的空白。

Method: 在公共物品博弈“Clean Up”中，对比人类和AI在身份可识别与匿名条件下的表现，并开发新的声誉合作模型。

Result: 人类和AI在身份可识别时表现更优，均采用轮流策略；匿名条件下表现较差。

Conclusion: 多智能体强化学习能有效模拟复杂环境中的人类社会行为，身份识别和声誉机制是关键。
...
### [41] [A MARL-based Approach for Easing MAS Organization Engineering](https://arxiv.org/abs/2506.05437)
*Julien Soulé,Jean-Paul Jamont,Michel Occello,Louis-Marie Traonouez,Paul Théron*

Main category: cs.MA

TL;DR: 论文提出了一种名为AOMEA的方法，通过结合多智能体强化学习（MARL）和组织模型，辅助设计多智能体系统（MAS）的组织结构，以解决复杂部署环境中的高成本和安全性问题。


<details>
  <summary>Details</summary>
Motivation: 在复杂或低可读性的部署环境中，传统依赖设计者知识的方法成本高且存在安全隐患，因此需要一种更高效的方法来辅助MAS的组织设计。

Method: AOMEA方法结合了多智能体强化学习（MARL）和组织模型，生成相关的组织规范，以支持MAS的工程设计。

Result: AOMEA能够为MAS的组织设计提供有效的建议，降低设计成本并提高安全性。

Conclusion: AOMEA为复杂环境中的MAS组织设计提供了一种可行的解决方案，具有实际应用潜力。
...
### [42] [Sequence Modeling for N-Agent Ad Hoc Teamwork](https://arxiv.org/abs/2506.05527)
*Caroline Wang,Di Yang Shi,Elad Liebman,Ishan Durugkar,Arrasy Rahman,Peter Stone*

Main category: cs.MA

TL;DR: 论文提出了一种基于Transformer的集中式方法（MAT-NAHT），用于解决N-agent ad hoc teamwork（NAHT）问题，优于现有独立学习方法POAM。


<details>
  <summary>Details</summary>
Motivation: 现有方法POAM仅采用独立学习，无法充分捕捉多智能体间的动态协作关系，而Transformer能有效处理变长序列，适合解决NAHT问题。

Method: 提出集中式Transformer方法，整合所有受控智能体的历史观察和动作，以应对部分可观测环境中多样且未知的队友。
...
### [43] [Using Large Language Models to Simulate Human Behavioural Experiments: Port of Mars](https://arxiv.org/abs/2506.05555)
*Oliver Slumbers,Joel Z. Leibo,Marco A. Janssen*
...
<details>
  <summary>Details</summary>
Motivation: 理解CRSD（如气候变化）的社会基础需要大规模实验，但传统方法难以保证多样性和统计功效。生成式AI提供了一种补充方案。

Method: 利用大型语言模型（LLM）模拟人类参与者，验证其在大规模CRSD实验中的有效性和多样性表现。

Result: 研究表明，LLM可以作为一种可行的工具，模拟具有多样性的人类行为，用于CRSD研究。

Conclusion: 生成式AI为CRSD研究提供了新的可能性，但需进一步验证其与真实人类行为的匹配度。
...
### [44] [Modeling human reputation-seeking behavior in a spatio-temporally complex public good provision game](https://arxiv.org/abs/2506.06032)
*Edward Hughes,Tina O. Zhu,Martin J. Chadwick,Raphael Koster,Antonio García Castañeda,Charles Beattie,Thore Graepel,Matthew M. Botvinick,Joel Z. Leibo*

Main category: cs.MA

TL;DR: 多智能体强化学习可用于模拟复杂社会行为，但缺乏实验支持。本文通过实验验证其在公共物品游戏中的表现，发现人类和AI在可识别身份时表现更好，均采用轮流策略。


<details>
  <summary>Details</summary>
Motivation: 验证多智能体强化学习在复杂社会行为建模中的有效性，尤其是与人类行为的对比。

Method: 在公共物品游戏Clean Up中，对比人类和AI在身份可识别与匿名条件下的表现。

Result: 人类和AI在身份可识别时表现更优，均采用轮流策略解决问题。
